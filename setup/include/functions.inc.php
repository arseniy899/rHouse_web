...
function draw_side_navigation($step = 1, $draw = true)
{
	$steps = array(
		...
		'4'=>array('url'=>'hub_secret.php', 'text'=>lang_key('hub_secret')),
		'5'=>array('url'=>'paths.php', 'text'=>lang_key('hub_connection')),
		//'6'=>array('url'=>'register_hub.php', 'text'=>lang_key('register_hub')),
