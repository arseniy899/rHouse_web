<?php
    ...
    $arr_active_languages = array(
        'ru'=>array('name'=>'Русский', 'direction'=>'ltr'),
    ...
    define('EI_CONFIG_FILE_DIRECTORY', __DIR__.'/../../');
    ...
    define('EI_CONFIG_FILE_PATH', __DIR__."/../../config.php");
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'Smart House');
	...
	foreach( $files as $file)
	{
		...
		if( strpos($file, 'v') === 0 )
		{
			$versions[] = str_ireplace("v","",$file);
		}
	}
	//usort($versions, 'version_compare');
	uasort($versions, 'cmp');
	define('EI_APPLICATION_VERSION', 'v'.end($versions));
