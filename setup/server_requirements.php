<?php
	...
	$validations = array(
		...
		'pdo_support'  => array(true, lang_key('pdo_support'), (isset($phpinfo['PDO']['PDO support']) && $phpinfo['PDO']['PDO support'] == 'enabled'), lang_key('enabled'), lang_key('disabled'), lang_key('error_pdo_support')),
		...
		//'short_open_tag'  => array(true, lang_key('short_open_tag'), (isset($phpinfo[$php_core_index]) && $phpinfo[$php_core_index]['short_open_tag'][0] == 'On'), lang_key('on'), lang_key('off')),
	...
	if(EI_CHECK_MODES){
		...
		$validations['mod_ldap'] = array(true, lang_key('mode').' LDAP', in_array('ldap', $loaded_extensions), lang_key('installed'), lang_key('not_installed'));
	}
	...
	if(EI_CHECK_DIRECTORIES_AND_FILES){
		...
		$validations['config_file_dir'] = array(true, EI_CONFIG_FILE_DIRECTORY, file_exists(EI_CONFIG_FILE_DIRECTORY) && is_writable(EI_CONFIG_FILE_DIRECTORY), lang_key('writable'), lang_key('no_writable'));		
