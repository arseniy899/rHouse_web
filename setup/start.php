	...
	<div id="content">
		...
		<div class="central-part">
			...
			<?
				...
				<h4><?php echo lang_key('installation_completed'); ?></h4>
				<a class="form_button" href="<?php echo '../'.EI_APPLICATION_START_FILE;?>">
							<?php echo lang_key('proceed_to_login_page'); ?></a>
			<?}?>
		</div>
		<div class="clear"></div>
	</div>
