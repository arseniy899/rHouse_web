...
(function($) {
	...
	$.colorPick = function(element, options) {
		...
		var uniquePalette = [];
		$.each($.fn.colorPick.defaults.palette.map(function(x) {
	...
	$.colorPick.prototype = {
		init: function() {
			...
			this.element.click(function(event) {
				...
				self.show(event.pageX-140, event.pageY);
		...
		appendToStorage: function(color) {
			if ($.fn.colorPick.defaults.allowRecent === !0) {
		...
		show: function(left, top) {
			...
			if ($.fn.colorPick.defaults.allowCustomColor === !0) {
