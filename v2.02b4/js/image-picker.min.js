...
(function() {
    ...
    jQuery.fn.extend({
        ...
        for (a = a.slice(0), b = b.slice(0), a.sort(), b.sort(), i = j = 0, len = a.length; j < len; i = ++j)
        ...
        return _createClass(ImagePicker, [{
            key: "destroy",
            value: function() {
                var j, len, ref;
            ...
            value: function(scoped_dom, target_container) {
                ...
                for (ref1 = function() {
                        ...
                        for (results1 = [], l = 0, len1 = (ref1 = scoped_dom.children("option")).length; l < len1; l++) option = ref1[l], results1.push(new ImagePickerOption(option, this, this.opts));
                        return results1
        ...
        function ImagePickerOption(option_element, picker) {
            ...
            _classCallCheck(this, ImagePickerOption), this.clicked = this.clicked.bind(this), this.picker = picker, this.opts = opts1, this.option = jQuery(option_element), this.create_node()
        }
        return _createClass(ImagePickerOption, [{
            key: "destroy",
            value: function() {
