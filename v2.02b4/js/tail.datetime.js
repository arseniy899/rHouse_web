...
;(function(root, factory){
    ...
    datetime.strings = {
        ...
        ru: {
            ...
            shorts: ["ВС", "ПН", "ВТ", "СР", "ЧЕТ", "ПЯТ", "СУБ"],
    ...
    datetime.prototype = {
        ...
        selectDate: function(Y, M, D, H, I, S){
            ...
            this.select = (Y instanceof Date)? Y: new Date(
                ...
                //H? H: n.getHours(),
                H? H: (H == undefined)? this.view.date.getHours():    n.getHours(),
                I? I: (I == undefined)? this.view.date.getMinutes():  0,
                S? S: (S == undefined)? this.view.date.getSeconds():  0
            );
			if(this.select.getHours() == 0)
				this.select.setHours(n.getHours());
			if(this.select.getMinutes() == 0)
			this.select.setMinutes(n.getMinutes());
